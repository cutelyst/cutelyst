...
public:
     ...
     */
    ValidatorBoolean(const QString &field, const QString &label = QString(), const QString &customError = QString(), QObject *parent = nullptr);
...
protected:
    ...
    ValidatorBoolean(ValidatorBooleanPrivate &dd, QObject *parent);
