...
ValidatorReturnType ValidatorBefore::validate(Context *c, const ParamsMultiMap &params) const
{
    ...
    if (!v.isEmpty()) {
        ...
        const QTimeZone tz = ValidatorBeforePrivate::extractTimeZone(c, params, d->timeZone);
...
void ValidatorBefore::validateCb(Context *c, const ParamsMultiMap &params, ValidatorRtFn cb) const
{
