...
public:
     ...
     */
    ValidatorInteger(const QString &field, const QString &label = QString(), const QString &customError = QString(), QObject *parent = nullptr);
...
protected:
    ...
    ValidatorInteger(ValidatorIntegerPrivate &dd, QObject *parent);
