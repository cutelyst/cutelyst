...
public:
     ...
     */
    ValidatorNotIn(const QString &field, const QStringList &values, const QString &label = QString(), const QString &customError = QString(), QObject *parent = nullptr);
...
protected:
    ...
    ValidatorNotIn(ValidatorNotInPrivate &dd, QObject *parent);
