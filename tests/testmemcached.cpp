...
public:
    ...
    void setByteArrayByKey(Context *c)
    {
        ...
        if (Memcached::setByKey(
                QStringLiteral("myLittleGroup"), in.first, in.second.toUtf8(), 5, &rt)) {
            setValid(c);
        } else {
            setRt(c, rt);
        }
    ...
    void getByteArrayByKey(Context *c)
    {
        auto in = getKeyVal(c);
        Memcached::MemcachedReturnType rt;
        if (Memcached::getByKey(QStringLiteral("myLittleGroup"), in.first, nullptr, &rt) ==
            in.second.toUtf8()) {
            setValid(c);
        } else {
            setRt(c, rt);
    ...
    void setEmptyKeyByKey(Context *c)
    {
        ...
        setValidity(
            c,
            Memcached::setByKey(QStringLiteral("myLittleGroup"), QString(), QByteArray(), 5, &rt));
    }
    ...
    void setTooLongKeyByKey(Context *c)
    {
        ...
        Memcached::MemcachedReturnType rt;
        setValidity(
            c, Memcached::setByKey(QStringLiteral("myLittleGroup"), key, QByteArray(), 5, &rt));
    }
    ...
    void getQVariantList(Context *c)
    {
        ...
        const QVariantList list2 =
            Memcached::get<QVariantList>(QStringLiteral("varList"), nullptr, &rt);
    ...
    void setQVariantListByKey(Context *c)
    {
        ...
        setValidity(c,
                    Memcached::setByKey(
                        QStringLiteral("myListGroup"), QStringLiteral("varList2"), list, 5, &rt));
    }
    ...
    void getQVariantListByKey(Context *c)
    {
        Memcached::MemcachedReturnType rt;
        const QVariantList list1 = getTestVariantList();
        const QVariantList list2 = Memcached::getByKey<QVariantList>(
            QStringLiteral("myListGroup"), QStringLiteral("varList2"), nullptr, &rt);
        setValidity(c, list1 == list2);
    }
    ...
    void addByteArrayValid(Context *c)
    {
        Memcached::MemcachedReturnType rt;
        setValidity(
            c, Memcached::add(QStringLiteral("add1"), QByteArrayLiteral("Lorem ipsum"), 5, &rt));
    }
    ...
    void addByteArrayValidByKey(Context *c)
    {
        Memcached::MemcachedReturnType rt;
        setValidity(c,
                    Memcached::addByKey(QStringLiteral("addGroup"),
                                        QStringLiteral("add3"),
    ...
    void addByteArrayInvalidByKey(Context *c)
    {
        Memcached::MemcachedReturnType rt;
        setValidity(c,
                    Memcached::addByKey(QStringLiteral("addGruop"),
                                        QStringLiteral("add3"),
                                        QByteArrayLiteral("Lorem ipsum"),
                                        5,
                                        &rt));
    ...
    {
        Memcached::MemcachedReturnType rt;
        const QByteArray ba1 =
            Memcached::getByKey(QStringLiteral("addGroup"), QStringLiteral("add3"), nullptr, &rt);
        const QByteArray ba2 = QByteArrayLiteral("Lorem ipsum");
        setValidity(c, ba1 == ba2);
    }
    ...
    void addQVariantListValidByKey(Context *c)
    {
        ...
        setValidity(
            c,
            Memcached::addByKey(QStringLiteral("addGroup"), QStringLiteral("add4"), list, 2, &rt));
    }
    ...
    void getAfterAddQVariantListByKey(Context *c)
    {
        Memcached::MemcachedReturnType rt;
        const QVariantList l1 = getTestVariantList();
        const QVariantList l2 = Memcached::getByKey<QVariantList>(
            QStringLiteral("addGroup"), QStringLiteral("add4"), nullptr, &rt);
        setValidity(c, l1 == l2);
    }
    ...
    void replaceByteArrayValid(Context *c)
    {
        ...
        setValidity(c,
                    Memcached::replace(
                        QStringLiteral("replace1"), QByteArrayLiteral("Lorem ipsum 2"), 5, &rt));
    }
    ...
    void replaceByteArrayInvalid(Context *c)
    {
        ...
        setValidity(c,
                    Memcached::replace(
                        QStringLiteral("replace2"), QByteArrayLiteral("Lorem ipsum 2"), 5, &rt));
    }
    ...
    void getAfterReplaceQVariantList(Context *c)
    {
        ...
        const QVariantList l2 =
            Memcached::get<QVariantList>(QStringLiteral("replace3"), nullptr, &rt);
        setValidity(c, l1 == l2);
    }
    ...
    {
        Memcached::setByKey(QStringLiteral("replaceGroup"),
                            QStringLiteral("replace5"),
                            QByteArrayLiteral("Lorem ipsum"),
                            5);
        Memcached::MemcachedReturnType rt;
        setValidity(c,
                    Memcached::replaceByKey(QStringLiteral("replaceGroup"),
                                            QStringLiteral("replace5"),
    ...
    void getAfterReplaceByteArrayByKey(Context *c)
    {
        Memcached::MemcachedReturnType rt;
        const QByteArray ba1 = QByteArrayLiteral("Lorem ipsum 2");
        const QByteArray ba2 = Memcached::getByKey(
            QStringLiteral("replaceGroup"), QStringLiteral("replace5"), nullptr, &rt);
        setValidity(c, ba1 == ba2);
    }
    ...
    void replaceQVariantListValidByKey(Context *c)
    {
        ...
        setValidity(c,
                    Memcached::replaceByKey(
                        QStringLiteral("replaceGroup"), QStringLiteral("replace7"), list2, 5, &rt));
    }
    ...
    void replaceQVariantListInvalidByKey(Context *c)
    {
        ...
        setValidity(c,
                    Memcached::replaceByKey(
                        QStringLiteral("replaceGroup"), QStringLiteral("replace8"), list, 5, &rt));
    }
    ...
    void getAfterReplaceQVariantListByKey(Context *c)
    {
        ...
        const QVariantList l1 = getTestVariantList();
        const QVariantList l2 = Memcached::getByKey<QVariantList>(
            QStringLiteral("replaceGroup"), QStringLiteral("replace7"), nullptr, &rt);
        setValidity(c, l1 == l2);
    }
    ...
    {
        Memcached::setByKey(QStringLiteral("remGroup"),
                            QStringLiteral("rem3"),
                            QByteArrayLiteral("Lorem ipsum"),
                            300);
        Memcached::MemcachedReturnType rt;
        setValidity(
            c, Memcached::removeByKey(QStringLiteral("remGroup"), QStringLiteral("rem3"), &rt));
    }
    ...
    void directRemoveInvalidByKey(Context *c)
    {
        Memcached::MemcachedReturnType rt;
        setValidity(
            c, Memcached::removeByKey(QStringLiteral("remGroup"), QStringLiteral("rem4"), &rt));
    }
    ...
    {
        const QByteArray ba1 = QByteArrayLiteral("Lorem ipsum");
        const QByteArray ba2 =
            Memcached::getByKey(QStringLiteral("remGroup"), QStringLiteral("rem3"));
        setValidity(c, ba1 == ba2);
    }
    ...
    void existInvalid(Context *c) { setValidity(c, Memcached::exist(QStringLiteral("exist2"))); }

    // **** Start testing exist by key valid ****
    C_ATTR(existByKeyValid, :Local :AutoArgs)
    void existByKeyValid(Context *c)
    {
        Memcached::setByKey(QStringLiteral("existGroup"),
                            QStringLiteral("exist3"),
                            QByteArrayLiteral("Lorem ipsum"),
                            10);
        setValidity(c,
                    Memcached::existByKey(QStringLiteral("existGroup"), QStringLiteral("exist3")));
    }
    ...
    {
        setValidity(c,
                    Memcached::existByKey(QStringLiteral("existGroup"), QStringLiteral("exist4")));
    }
    ...
    void incrementWithInitialByKeyValid(Context *c)
    {
        ...
        if (!Memcached::incrementWithInitialByKey(
                QStringLiteral("incGroup"), QStringLiteral("inc3"), 1, initial, 10, &val)) {
            setInvalid(c);
        } else {
            setValidity(c, initial == val);
        }
    ...
    {
        uint64_t val = 0;
        if (!Memcached::incrementByKey(
                QStringLiteral("incGroup"), QStringLiteral("inc3"), 1, &val)) {
            setInvalid(c);
        } else {
            setValidity(c, 12 == val);
        }
    ...
    {
        const QByteArray ba =
            Memcached::getByKey(QStringLiteral("incGroup"), QStringLiteral("inc3"));
        uint64_t val = ba.trimmed().toULongLong();
        setValidity(c, val == 12);
    }
    ...
    void incrementByKeyInvalid(Context *c)
    {
        ...
        setValidity(
            c,
            Memcached::incrementByKey(QStringLiteral("incGroup"), QStringLiteral("inc4"), 1, &val));
    }
    ...
    void decrementWithInitialByKeyValid(Context *c)
    {
        ...
        if (!Memcached::decrementWithInitialByKey(
                QStringLiteral("decGroup"), QStringLiteral("inc7"), 1, initial, 10, &val)) {
            setInvalid(c);
        } else {
            setValidity(c, initial == val);
        }
    ...
    {
        uint64_t val = 0;
        if (!Memcached::decrementByKey(
                QStringLiteral("decGroup"), QStringLiteral("inc7"), 1, &val)) {
            setInvalid(c);
        } else {
            setValidity(c, 8 == val);
        }
    ...
    {
        const QByteArray ba =
            Memcached::getByKey(QStringLiteral("decGroup"), QStringLiteral("inc7"));
        uint64_t val = ba.trimmed().toULongLong();
        setValidity(c, val == 8);
    }
    ...
    void decrementByKeyInvalid(Context *c)
    {
        ...
        setValidity(
            c,
            Memcached::decrementByKey(QStringLiteral("decGroup"), QStringLiteral("inc8"), 1, &val));
    }
    ...
    void casValid(Context *c)
    {
        ...
        if (Memcached::cas(QStringLiteral("cas1"), QByteArrayLiteral("Lorem ipsum"), 60, cas)) {
            setValidity(c,
                        Memcached::get(QStringLiteral("cas1")) == QByteArrayLiteral("Lorem ipsum"));
        } else {
            setInvalid(c);
        }
    }
    ...
    void casInvalid(Context *c)
    {
        ...
        if (Memcached::cas(QStringLiteral("cas2"), QByteArrayLiteral("Lorem ipsum"), 60, cas)) {
            setValidity(c,
                        Memcached::get(QStringLiteral("cas2")) == QByteArrayLiteral("Lorem ipsum"));
        } else {
            setInvalid(c);
        }
    }
    ...
    {
        uint64_t cas = 0;
        Memcached::setByKey(QStringLiteral("casGroup"),
                            QStringLiteral("cas5"),
                            QByteArrayLiteral("Lorem ipsum"),
                            60);
        Memcached::setByKey(QStringLiteral("casGroup"),
        ...
        if (Memcached::casByKey(QStringLiteral("casGroup"),
                                QStringLiteral("cas5"),
                                QByteArrayLiteral("Lorem ipsum"),
                                60,
                                cas)) {
            setValidity(c,
                        Memcached::getByKey(QStringLiteral("casGroup"), QStringLiteral("cas5")) ==
                            QByteArrayLiteral("Lorem ipsum"));
        } else {
            setInvalid(c);
        }
    ...
    void casByKeyInvalid(Context *c)
    {
        ...
        Memcached::setByKey(QStringLiteral("casGroup"),
                            QStringLiteral("cas6"),
                            QByteArrayLiteral("Lorem ipsum 3"),
                            60);
        if (Memcached::casByKey(QStringLiteral("casGroup"),
                                QStringLiteral("cas6"),
                                QByteArrayLiteral("Lorem ipsum"),
                                ...
                                cas)) {
            setValidity(c,
                        Memcached::getByKey(QStringLiteral("casGroup"), QStringLiteral("cas6")) ==
                            QByteArrayLiteral("Lorem ipsum"));
        } else {
            setInvalid(c);
        }
    ...
    void casByKeyVariantValid(Context *c)
    {
        ...
        if (Memcached::casByKey(
                QStringLiteral("casGroup"), QStringLiteral("cas7"), list1, 60, cas)) {
            setValidity(c,
                        Memcached::getByKey<QVariantList>(QStringLiteral("casGroup"),
                                                          QStringLiteral("cas7")) == list1);
        } else {
            setInvalid(c);
        }
    }
    ...
    void casByKeyVariantInvalid(Context *c)
    {
        ...
        Memcached::setByKey(QStringLiteral("casGroup"), QStringLiteral("cas8"), list1, 60);
        if (Memcached::casByKey(
                QStringLiteral("casGroup"), QStringLiteral("cas8"), list2, 60, cas)) {
            setValidity(c,
                        Memcached::getByKey<QVariantList>(QStringLiteral("casGroup"),
                                                          QStringLiteral("cas8")) == list2);
        } else {
            setInvalid(c);
        }
    }
