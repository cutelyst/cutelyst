 ...
 * \headerfile "" <Cutelyst/Plugins/Utils/validatorsize.h>
 ...
 * the value itself while for QString it will check the string length. Use \a size to define the
 * comparison value and \a type to set the type to check against. \a size will internally converted
 * into a comparative value (qlonglong for QMetaType::Int, qulonglong for QMetaType::UInt and int
 * for QMetaType::QString. Allowed types for the \a type specifier are all numeric types and
 * QMetaType::QString. Any other type will result in a validation data error.
 *
 * If you set a string to the \a size value, this will neither be interpreted as a number nor as
...
public:
    /**
     * Constructs a new %ValidatorSize object with the given parameters.
     *
     * \param field         Name of the input field to validate.
     * \param type          The type to compare.
     * \param size          The size to compare. Will be converted into comparable value. If it is
     *                      a QString, it will try to get the comparison value from the stash.
     ...
     */
    ValidatorSize(const QString &field,
                  QMetaType::Type type,
                  const QVariant &size,
