...
public:
     ...
     */
    ValidatorConfirmed(const QString &field, const QString &label = QString(), const QString &customError = QString(), QObject *parent = nullptr);
...
protected:
    ...
    ValidatorConfirmed(ValidatorConfirmedPrivate &dd, QObject *parent);
