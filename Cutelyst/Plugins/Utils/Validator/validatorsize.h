...
public:
     ...
     */
    ValidatorSize(const QString &field, QMetaType::Type type, double size, const QString &label = QString(), const QString &customError = QString(), QObject *parent = nullptr);
...
protected:
    ...
    ValidatorSize(ValidatorSizePrivate &dd, QObject *parent);
