...
public:
     ...
     * containing the allowed values or a QString specifing a stash key containing a QStringList
     * with allowed values. \param cs            Defines if the comparison should be performed case
     * sensitive or insensitive. \param messages      Custom error message if validation fails.
