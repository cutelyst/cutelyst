...
public:
     ...
     * or QMetaType::QString. \param min           Minimum value. Will be converted into comparable
     * value. If it is a QString, it will try to get the comparison value from another params field
     * or the stash. \param max           Maximum value. Will be converted into comparable value. If
     * it is a QString, it will try to get the comparison value from another params field or the
     * stash. \param messages      Custom error message if validation fails. \param defValKey \link
