...
public:
     ...
     */
    ValidatorAlpha(const QString &field, const QString &label = QString(), const QString &customError = QString(), QObject *parent = nullptr);
...
protected:
    ...
    ValidatorAlpha(ValidatorAlphaPrivate &dd, QObject *parent);
