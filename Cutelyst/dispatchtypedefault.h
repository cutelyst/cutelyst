...
#ifndef CUTELYST_DISPATCHTYPEDEFAULT_H
#define CUTELYST_DISPATCHTYPEDEFAULT_H

#include "dispatchtype.h"

namespace Cutelyst {

class DispatchTypeDefault : public CutelystDispatchType
{
    Q_OBJECT
public:
    explicit DispatchTypeDefault(QObject *parent = 0);
...
#endif // CUTELYST_DISPATCHTYPEDEFAULT_H
